...
const woodburningData = {
    ...
    'dateFinished': new Date("December 10, 1815"),
...
exports.addNewWoodburningToDB = functions.https.onRequest((request, response) => {
    console.log(request);
...
exports.editWoodburningFromDB = functions.https.onRequest((request, response) => {
    console.log(request);
...
exports.deleteWoodburningFromDB = functions.https.onRequest((request, response) => {
    console.log(request);
...
exports.listWoodburningsFromDB = functions.https.onRequest((request, response) => {
    console.log(request);
...
exports.getWoodburningFromDB = functions.https.onRequest((request, response) => {
    console.log(request);
...
exports.listForSaleWoodburningsFromDB = functions.https.onRequest((request, response) => {
    console.log(request);
    const forSaleRef = firestoreDatabase.collection("woodburnings");
    const query = forSaleRef.where("forSale", "==", true);
    return query;
});
exports.listNotSoldWoodburningsFromDB = functions.https.onRequest((request, response) => {
    console.log(request);
    const forSaleRef = firestoreDatabase.collection("woodburnings");
